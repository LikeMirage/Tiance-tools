...
def run(payload):
    ...
    return call_host_capability("github_platform", {"action":payload["action"],"dryRun":bool(payload.get("dry_run",False)),"parameters":payload.get("parameters") or {}}, timeout_seconds=570)
