...
def run(payload):
    ...
    request = {"action": payload["action"], "dryRun": bool(payload.get("dry_run", False)), "parameters": payload.get("parameters") or {}}
    return call_host_capability("github_platform", request, timeout_seconds=570)
